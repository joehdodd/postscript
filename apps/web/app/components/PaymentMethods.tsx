      ...
      <div className="bg-ps-secondary rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium bg-ps-primary-600 text-green-600 rounded-md hover:bg-ps-primary-700 transition-colors duration-200 disabled:opacity-50"
          >
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      {method.isDefault && (
                        <span className="px-2 py-1 bg-ps-secondary-500 text-green-600 text-xs rounded-full">
                          Default
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center space-x-2">
                  {!method.isDefault && (
                    ...
                    >
                      {isLoadingDefault ? 'Setting...' : 'Set Default'}
                    </button>
                  )}
                  <button
        ...
        {paymentMethods.length > 0 && (
          <div className="mt-6 p-4 bg-ps-neutral-50 rounded-lg">
            <p className="text-sm text-ps-text-secondary">
              ...
              for subscription renewals and any additional charges.
            </p>
          </div>
        )}
      </div>
